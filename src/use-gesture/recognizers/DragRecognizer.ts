...
function persistEvent(event: any) {
...
export class DragRecognizer extends CoordinatesRecognizer<'drag'> {
  ...
  startDrag(event: PointerEvent, onDragIsStart: boolean = false) {
